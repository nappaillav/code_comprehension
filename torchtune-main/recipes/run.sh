#!/bin/bash
#SBATCH --job-name=LLMcode-0.3
#SBATCH --output=/home/vdhee/scratch/LLMcode/Train/full_finetuning_results-3/outputs-0.3/job_output-0.5-human.txt
#SBATCH --error=/home/vdhee/scratch/LLMcode/Train/full_finetuning_results-3/outputs-0.3/job_error-0.5-human.txt
#SBATCH --ntasks=1
